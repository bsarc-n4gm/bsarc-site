...
Unlike private organizational programs, AUXCOMM hams are formally registered auxiliary government volunteers mobilized under state directives to execute direct communications support inside local municipal assets—including Emergency Operations Centers (EOCs), mobile public safety command trailers, and municipal 911 dispatch centers during official county disaster declarations.

---

## 🛡️ Leadership & Directives Coordination
...
* **AUXCOMM Auxiliary Network Check-in:** Every Monday evening at **7:00 PM** using the primary `147.315 MHz` local repeater.

---

## 🎓 Mandatory DHS NIMS Certification Requirements
...
2. 🔠 **IS-200** — Basic Incident Command System for Initial Response
3. 🔀 **IS-700** — National Incident Management System (NIMS) Introduction
4. 🌐 **IS-800** — National Response Framework Introduction

Foundational certifications are completed free of charge via the **[FEMA Independent Study Course Directory](https://training.fema.gov/is/crslist.aspx)**.

### 📋 The Official Credentialing Pathway
...
## 🏢 Public Safety Systems Reference Links

* 🏢 **County Public Safety Gateway:** [Brunswick County Emergency Services Portal](http://www.brunswickcountync.gov/)
* 📡 **Federal Communications Infrastructure:** [CISA SAFECOM / AUXCOMM Programs Hub](https://www.cisa.gov/safecom/focal-points/auxiliary-communications)